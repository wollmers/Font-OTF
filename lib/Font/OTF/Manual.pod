...
Font::OTF::Manual - Information regarding the whole module set
...
font. This may be achieved by:
    ...
    $f = Font::OTF::Font->open($filename) || die "Unable to read $filename";
...
internals of glyphs in which case see L<Font::OTF::Glyph> for more details.
...
for a glyph may be found in L<Font::OTF::Glyph>. Once we have all the
